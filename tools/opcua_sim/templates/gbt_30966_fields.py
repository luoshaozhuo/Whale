...
WPPD = LogicalNodeDef(
    ...
    fields=[
        ...
        _f("LocSta",  1.0, "",   "厂站级权限切换(沿用 DL/T 860.74)", cdc="SPC"),
        _f("EEHealth", 1.0, "",  "外部设备健康状态(沿用 DL/T 860.74)", cdc="INS"),
        _f("RsStat",  0.0, "",   "复位设备统计(沿用 DL/T 860.74)", cdc="SPC"),
        _f("CleRfTyp", 0.0, "",  "更新闻隔时间类型", cdc="ENG"),
        _f("OpCntRs", 0.0, "",   "操作计数器复位(沿用 DL/T 860.74)", cdc="INC"),
        _f("OpCnt",   500.0, "", "操作计数器(沿用 DL/T 860.74)", cdc="INS"),
        _f("OpTmh",   87600.0, "h", "以小时为单位运行时间(沿用 DL/T 860.74)", cdc="INS"),
        _f("NumPwrUp", 500.0, "", "上电次数(沿用 DL/T 860.74)", cdc="INS"),
        _f("WrmStr",  500.0, "", "软启动次数(沿用 DL/T 860.74)", cdc="INS"),
        _f("WacTrg",  3.0, "",   "检测到的看门狗复位次数(沿用 DL/T 860.74)", cdc="INS"),
...
# =============================================================================
LTIM = LogicalNodeDef(
    name="LTIM", desc="时间管理(沿用 DL/T 860.74)",
    fields=[
